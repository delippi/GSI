...
! Declare local variables
  ...
  real(r_kind),dimension(nsig):: zges_read_reverse, zges_geometric_reverse, zges_read, zges_geometric
...
!   interpolate geopotential height to location
    ...
    call tintrp2a1(geop_hgtl,zges_read,dlat,dlon,dtime,hrdifsig, nsig,mype,nfldsig)
...
!   call nc_diag_data2d("geopotential_height", sngl(hsges_reverse) )       !orig
    ...
    !call nc_diag_data2d("surface_geometric_height", sngl(zges_geometric_reverse(1)) )
    !!emily
    !<<emily
