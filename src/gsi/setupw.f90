...
! !USES:
  ...
  use constants, only: zero,half,one,tiny_r_kind,two, &
           three,rd,grav,four,five,huge_single,r100,r1000,wgtlim,r10,r400,t0c
...
!       convert geopotential to geometric height.
        ...
        if (((itype>=223 .and. itype<=228) .or. itype == 218 .or. sfc_data .or. itype == 288) .and. .not.twodvar_regional) then
